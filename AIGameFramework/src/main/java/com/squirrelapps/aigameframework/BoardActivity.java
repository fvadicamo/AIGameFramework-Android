...
//        });
        ...
        FrameLayout.LayoutParams pTable = new FrameLayout.LayoutParams(
                ...
                TableRow.LayoutParams.WRAP_CONTENT);
        table.setBackgroundColor(Color.RED); //FIXME rimuovere a fine debug
...
//        table.addView(rowBottom, pRowBottom);
        ...
        //TODO in alternativa ci si potrebbe registrare come GlobalLayoutListener e leggere la dim del layout o della table stessa!
